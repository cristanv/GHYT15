...
/**
 * its contains WebDriver specific reusable action
 * @author Cristan
 *
 */
 ...
 */
	...
	public void executeJavaScript(WebDriver driver , String javaScript) {
	   ...
	   public void switchToChildWindow(WebDriver driver,String PartialWindowText) {
	   Set<String> set = driver.getWindowHandles();		
		Iterator<String> it = set.iterator();//Iterator through the set
				
		while(it.hasNext()) {
			String wid = it.next();
			driver.switchTo().window(wid);
			String currentwindowHandle = driver.findElement(By.className("moduleName")).getText();
			
			if(currentwindowHandle.contains(PartialWindowText)) {
				break;
			}				
		 }
	   }   
	   
	   public void switchToParentWindow(WebDriver driver,String PartialWindowText) {
	   Set<String> set2 = driver.getWindowHandles();
		Iterator<String> it2 = set2.iterator();	
		while(it2.hasNext()) {
			String wid3 = it2.next();
			driver.switchTo().window(wid3);
			String currentwindowTitle =driver.findElement(By.xpath("(//a[.='Campaigns'])[3]")).getText();
			
			if(currentwindowTitle.contains(PartialWindowText)) {
				break;
			}
		}	
	   }
